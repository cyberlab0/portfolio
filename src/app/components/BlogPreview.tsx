        ...
        <div className="grid md:grid-cols-3 gap-8">
          {posts.map((post, idx) => (
            <motion.div
              ...
              className="group flex flex-col h-full bg-[#151b2b] border border-slate-800 rounded-2xl p-6 relative overflow-hidden"
            >
              ...
              <h3 className="text-xl font-bold text-slate-200 mb-3 relative z-10">
                {post.title}
              </h3>
